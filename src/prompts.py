...
PLANNER_PROMPT = weave.StringPrompt("""You are a planning agent in a multi-agent orchestration system.
...
RESEARCHER_PROMPT = weave.StringPrompt("""You are a research agent. Given a topic or question,
...
ANALYZER_PROMPT = weave.StringPrompt("""You are an analysis agent. Given data or information from other agents,
...
VALIDATOR_PROMPT = weave.StringPrompt("""You are a validation agent. Review outputs from other agents for:
- Factual accuracy
- Logical consistency
...
SYNTHESIZER_PROMPT = weave.StringPrompt("""You are a synthesis agent. Combine outputs from multiple agents into
